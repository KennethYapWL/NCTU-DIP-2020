...
% The best result will be demostrated on solution_img2.m
% ================================
...
[trans_R, transFunc] = piecewise_linear_streching(imgMatr_R,25,75,75,255);
[trans_G, transFunc] = piecewise_linear_streching(imgMatr_G,25,75,75,255);
[trans_B, transFunc] = piecewise_linear_streching(imgMatr_B,25,75,75,255);
...
% b. only on I (HSI)
[trans_I, transFunc] = piecewise_linear_streching(imgMatr_I,20,50,50,200);
...
% a. on R,G,B separately
trans_R = power_law_transform(imgMatr_R,1,0.8);
trans_G = power_law_transform(imgMatr_G,1,0.8);
trans_B = power_law_transform(imgMatr_B,1,0.8);
...
% b. only on I (HSI)
trans_I = power_law_transform(imgMatr_I,1,1.1);
transImgHSI = zeros(size(imgMatr));
